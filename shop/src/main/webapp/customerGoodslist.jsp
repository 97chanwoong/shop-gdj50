								...
								<div class="col">
									...
									<div
										...
										<ul class="product_sorting">
											<li><span>Show:</span> <span class="num_sorting_text">20</span>
												<i class="fa fa-angle-down"></i>
												<ul >
													<li class="num_sorting_btn"><span>20</span></li>
													<li class="num_sorting_btn"><a href="<%=request.getContextPath()%>/customerGoodslist.jsp?rowPerPage=40"><span>40</span></a></li>
												</ul>
												</li>
										</ul>
									</div>
