                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                      	<input type="text" class="form-control" id="customerName" value="<%=map.get("customerName")%>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="ordersName" value="<%=customerId%>" readonly="readonly">
                                    </div>
