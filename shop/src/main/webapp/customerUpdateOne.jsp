					...
					<div class="col-1"></div>
						<div class="col-8">
							...
							<form id="updateCustomerForm"
								action="<%=request.getContextPath()%>/customerUpdateOneAction.jsp"
								method="post">
								<label style="font-family: 'Jua', sans-serif;" for="customerId">아이디</label>
								<input style="font-family: 'Jua', sans-serif;" 
									   type="text" class="form-control" name="customerId" value="<%=customerId%>"
									   readonly="readonly">
								<br>		
							...
							<div class="form-group">	
								<button id="updateBtn" type="button"
										...
										style="font-family: 'Jua', sans-serif;">수정</button> 
							</div>			       
							</form>
							<br>
							<div class="row">
